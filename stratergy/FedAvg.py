...
class FedCustomAvg(Strategy):
    ...
    evaluate_fn : Optional[Callable[[torch.nn.Module, torch.utils.data.DataLoader, str, str], Optional[Tuple[float, dict[str, Scalar]]]]]
    ...
    server_testset: server-side evaluation data.
    net: torch.nn.Module
    ...
    def __init__(
        ...
        *,
        ...
        evaluate_fn: Optional[
            Callable[
                [torch.nn.Module, torch.utils.data.DataLoader, str, str], Optional[Tuple[float, dict[str, Scalar]]]
            ]
        ] = None,
        ...
        inplace: bool = True,
        server_testset: Optional[torch.utils.data.dataloader.DataLoader] = None,
        ...
        self.server_eval_data = server_testset
        self.net = net
        self.device = device
    ...
    def aggregate_fit(
        ...
        # eval_loss = None
        # if (server_round % 1 == 0) and (server_round!=0):  # Run evaluation every round
        #     print(f"Evaluating global model at the end of round {server_round}")
        #     eval_loss, metrics = self.evaluate(server_round, parameters_aggregated)
